...
ActiveRecord::Schema.define(version: 20160924153712) do
  ...
  create_table "geoips", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "ipaddress"
    t.string   "latitude"
    t.string   "longitude"
    t.datetime "created_at", null: false
  ...
  create_table "twines", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "locate"
    t.string   "temp"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
